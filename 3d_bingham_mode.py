...
D_pert[0,0,:,:,:] = 0.0 #only z affected                          
D_pert[0,1,:,:,:] = (np.cos(3*z))*initial_perturbation_size
D_pert[0,2,:,:,:] = (np.cos(3*z))*initial_perturbation_size
D_pert[1,0,:,:,:] = (np.cos(3*z))*initial_perturbation_size
D_pert[1,1,:,:,:] = 0.0
D_pert[1,2,:,:,:] = (np.cos(3*z))*initial_perturbation_size
D_pert[2,0,:,:,:] = (np.cos(3*z))*initial_perturbation_size
D_pert[2,1,:,:,:] = (np.cos(3*z))*initial_perturbation_size
D_pert[2,2,:,:,:] = 0.0
D += D_pert #D remains symmetric and conserves trace 1
...
for i_ind,i in enumerate(ns):
    ...
    Dh00_total[i_ind] = Dh_tilde[0,0,2,3,7]
    Dh01_total[i_ind] = Dh_tilde[0,1,2,3,7]
    Dh02_total[i_ind] = Dh_tilde[0,2,2,3,7]
    Dh10_total[i_ind] = Dh_tilde[1,0,2,3,7]
    Dh11_total[i_ind] = Dh_tilde[1,1,2,3,7]
    Dh12_total[i_ind] = Dh_tilde[1,2,2,3,7]
    Dh20_total[i_ind] = Dh_tilde[2,0,2,3,7]
    Dh21_total[i_ind] = Dh_tilde[2,1,2,3,7]
    Dh22_total[i_ind] = Dh_tilde[2,2,2,3,7]

    Dh_off = -(gamma+omega_k)*Dh_tilde
    Dh_diag = -omega_k*Dh_tilde

    Dh00_exp[i_ind] = Dh_diag[0,0,2,3,7]
    Dh01_exp[i_ind] = Dh_off[0,1,2,3,7]
    Dh02_exp[i_ind] = Dh_off[0,2,2,3,7]
    Dh10_exp[i_ind] = Dh_off[1,0,2,3,7]
    Dh11_exp[i_ind] = Dh_diag[0,0,2,3,7]
    Dh12_exp[i_ind] = Dh_off[1,2,2,3,7]
    Dh20_exp[i_ind] = Dh_off[2,0,2,3,7]
    Dh21_exp[i_ind] = Dh_off[2,1,2,3,7]
    Dh22_exp[i_ind] = Dh_diag[0,0,2,3,7]
...
file_Dh00_total = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh00_total.txt'
file_Dh01_total = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh01_total.txt'
file_Dh02_total = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh02_total.txt'
file_Dh10_total = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh10_total.txt'
file_Dh11_total = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh11_total.txt'
file_Dh12_total = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh12_total.txt'
file_Dh20_total = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh20_total.txt'
file_Dh21_total = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh21_total.txt'
file_Dh22_total = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh22_total.txt'

file_Dh00_exp = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh00_exp.txt'
file_Dh01_exp = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh01_exp.txt'
file_Dh02_exp = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh02_exp.txt'
file_Dh10_exp = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh10_exp.txt'
file_Dh11_exp = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh11_exp.txt'
file_Dh12_exp = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh12_exp.txt'
file_Dh20_exp = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh20_exp.txt'
file_Dh21_exp = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh21_exp.txt'
file_Dh22_exp = '/mnt/home/jflores/Doi-OnsagerModel/plane_wave_pert_z/D_pert/single_mode/Dh22_exp.txt'
