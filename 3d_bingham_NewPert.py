...
for i_ind, i in enumerate(ns):
    ...
    Dh00_exp = np.sqrt(((np.abs(Dh_diag[0,0]))**2).sum()*xh*yh*zh)
    Dh01_exp = np.sqrt(((np.abs(Dh_diag[0,1]))**2).sum()*xh*yh*zh)
    Dh02_exp = np.sqrt(((np.abs(Dh_off[0,2]))**2).sum()*xh*yh*zh)
    Dh10_exp = np.sqrt(((np.abs(Dh_diag[1,0]))**2).sum()*xh*yh*zh)
    Dh11_exp = np.sqrt(((np.abs(Dh_diag[1,1]))**2).sum()*xh*yh*zh)
    Dh12_exp = np.sqrt(((np.abs(Dh_off[1,2]))**2).sum()*xh*yh*zh)
    Dh20_exp = np.sqrt(((np.abs(Dh_off[2,0]))**2).sum()*xh*yh*zh)
    Dh21_exp = np.sqrt(((np.abs(Dh_off[2,1]))**2).sum()*xh*yh*zh)
    Dh22_exp = np.sqrt(((np.abs(Dh_diag[2,2]))**2).sum()*xh*yh*zh)
...
file_Dh00_total = '/mnt/home/jflores/Doi-OnsagerModel/Dh00_total.txt'
file_Dh01_total = '/mnt/home/jflores/Doi-OnsagerModel/Dh01_total.txt'
file_Dh02_total = '/mnt/home/jflores/Doi-OnsagerModel/Dh02_total.txt'
file_Dh10_total = '/mnt/home/jflores/Doi-OnsagerModel/Dh10_total.txt'
file_Dh11_total = '/mnt/home/jflores/Doi-OnsagerModel/Dh11_total.txt'
file_Dh12_total = '/mnt/home/jflores/Doi-OnsagerModel/Dh12_total.txt'
file_Dh20_total = '/mnt/home/jflores/Doi-OnsagerModel/Dh20_total.txt'
file_Dh21_total = '/mnt/home/jflores/Doi-OnsagerModel/Dh21_total.txt'
file_Dh22_total = '/mnt/home/jflores/Doi-OnsagerModel/Dh22_total.txt'

file_Dh00_exp = '/mnt/home/jflores/Doi-OnsagerModel/Dh00_exp.txt'
file_Dh01_exp = '/mnt/home/jflores/Doi-OnsagerModel/Dh01_exp.txt'
file_Dh02_exp = '/mnt/home/jflores/Doi-OnsagerModel/Dh02_exp.txt'
file_Dh10_exp = '/mnt/home/jflores/Doi-OnsagerModel/Dh10_exp.txt'
file_Dh11_exp = '/mnt/home/jflores/Doi-OnsagerModel/Dh11_exp.txt'
file_Dh12_exp = '/mnt/home/jflores/Doi-OnsagerModel/Dh12_exp.txt'
file_Dh20_exp = '/mnt/home/jflores/Doi-OnsagerModel/Dh20_exp.txt'
file_Dh21_exp = '/mnt/home/jflores/Doi-OnsagerModel/Dh21_exp.txt'
file_Dh22_exp = '/mnt/home/jflores/Doi-OnsagerModel/Dh22_exp.txt'
...
for i in range(len(Dh00_t)):
    if Dh00_t[i] > 0.0 and Dh00_t[i] < 40 and Dh00_total[i] < 45:
...
for i in range(len(Dh01_t)):
    if Dh01_t[i] > 0.0 and Dh01_t[i] < 40 and Dh01_total[i] < 45:
...
for i in range(len(Dh02_t)):
    if Dh02_t[i] > 0.0 and Dh02_t[i] < 40 and Dh02_total[i] < 45:
...
for i in range(len(Dh10_t)):
    if Dh10_t[i] > 0.0 and Dh10_t[i] < 25 and Dh10_total[i] < 30:
...
for i in range(len(Dh11_t)):
    if Dh11_t[i] > 0.0 and Dh11_t[i] < 40 and Dh11_total[i] < 45:
...
for i in range(len(Dh12_t)):
    if Dh12_t[i] > 0.0 and Dh12_t[i] < 25 and Dh12_total[i] < 50:
...
for i in range(len(Dh20_t)):
    if Dh20_t[i] > 0.0 and Dh20_t[i] < 25 and Dh20_total[i] < 30:
...
for i in range(len(Dh21_t)):
    if Dh21_t[i] > 0.0 and Dh21_t[i] < 40 and Dh21_total[i] < 45:
...
for i in range(len(Dh22_t)):
    if Dh22_t[i] > 0.0 and Dh22_t[i] < 25 and Dh22_total[i] < 50:
...
plt.figure()
plt.suptitle('$\\xi$ = '+str("{0:.2f}".format(kesi))+  ', $\\beta$ = '+str("{0:.2f}".format(beta)) +', $\\alpha$ = '+str("{0:.2f}".format(alpha)) +', $d_R$ = '+str("{0:.2f}".format(d_R))+', $d_T$ = '+str("{0:.2f}".format(d_T))+', Plane wave pert = $e^{ik_xx}*initial_perturbation_size*nx*ny/(2\\pi)$' )

ax = plt.subplot(gs[0,0])
plt.plot(Dh00_total_lin,y_00,label='$(\\hat{D}^{\\prime}_{00})_t=$'+str("{0:.2f}").format(A00)+'$\\hat{D}^{\\prime}_{00} $' )
plt.plot(Dh00_total_lin,Dh00_t_lin,':')
plt.plot(Dh00_total_lin,y_00_exp,label='$(\\hat{D}^{\\prime}_{00})_t=-\\omega_k\\hat{D}^{\\prime}_{00}=$'+str("{0:.2f}").format(A00_exp)+'$\\hat{D}^{\\prime}_{00} $' )
plt.plot(Dh00_total_lin,Dh00_exp_t_lin,':')
plt.xlabel('$\\hat{D}^{\\prime}_{00} $')
plt.ylabel('$(\\hat{D}^{\\prime}_{00})_t$')
plt.legend(loc='upper left')

ax = plt.subplot(gs[0,1])
plt.plot(Dh01_total_lin,y_01,label='$(\\hat{D}^{\\prime}_{01})_t=$'+str("{0:.2f}").format(A01)+'$\\hat{D}^{\\prime}_{01} $' )
plt.plot(Dh01_total_lin,Dh01_t_lin,':')
plt.plot(Dh01_total_lin,y_01_exp,label='$(\\hat{D}^{\\prime}_{01})_t=-(\\gamma+\\omega_k)\\hat{D}^{\\prime}_{01}=$'+str("{0:.2f}").format(A01_exp)+'$\\hat{D}^{\\prime}_{01} $' )
plt.plot(Dh01_total_lin,Dh01_exp_t_lin,':')
plt.xlabel('$\\hat{D}^{\\prime}_{01} $')
plt.ylabel('$(\\hat{D}^{\\prime}_{01})_t$')
plt.legend(loc='upper left')

ax = plt.subplot(gs[1,0])
plt.plot(Dh10_total_lin,y_10,label='$(\\hat{D}^{\\prime}_{10})_t=$'+str("{0:.2f}").format(A10)+'$\\hat{D}^{\\prime}_{10} $' )
plt.plot(Dh10_total_lin,Dh10_t_lin,':')
plt.plot(Dh10_total_lin,y_10_exp,label='$(\\hat{D}^{\\prime}_{10})_t=-(\\gamma+\\omega_k)\\hat{D}^{\\prime}_{10}=$'+str("{0:.2f}").format(A10_exp)+'$\\hat{D}^{\\prime}_{10} $' )
plt.plot(Dh10_total_lin,Dh10_exp_t_lin,':')
plt.xlabel('$\\hat{D}^{\\prime}_{10} $')
plt.ylabel('$(\\hat{D}^{\\prime}_{10})_t$')
plt.legend(loc='upper left')

ax = plt.subplot(gs[1,1])
plt.plot(Dh11_total_lin,y_11,label='$(\\hat{D}^{\\prime}_{11})_t=$'+str("{0:.2f}").format(A11)+'$\\hat{D}^{\\prime}_{11} $' )
plt.plot(Dh11_total_lin,Dh11_t_lin,':')
plt.plot(Dh11_total_lin,y_11_exp,label='$(\\hat{D}^{\\prime}_{11})_t=-\\omega_k\\hat{D}^{\\prime}_{11}=$'+str("{0:.2f}").format(A11_exp)+'$\\hat{D}^{\\prime}_{11} $' )
