...
kesi = 0.05          # mean-field torque strength
...
tmax = np.abs(math.floor(-np.log(initial_perturbation_size)/(gamma+omega)))-5
...
for i_ind, i in enumerate(ns):
    ...
    err_Dh00[i_ind] = L2_diff(D_tilde[0,0],xh,yh,zh)
    err_Dh01[i_ind] = L2_diff(D_tilde[0,1],xh,yh,zh)
    err_Dh02[i_ind] = L2_diff(D_tilde[0,2],xh,yh,zh)
    err_Dh10[i_ind] = L2_diff(D_tilde[1,0],xh,yh,zh)
    err_Dh11[i_ind] = L2_diff(D_tilde[1,1],xh,yh,zh)
    err_Dh12[i_ind] = L2_diff(D_tilde[1,2],xh,yh,zh)
    err_Dh20[i_ind] = L2_diff(D_tilde[2,0],xh,yh,zh)
    err_Dh21[i_ind] = L2_diff(D_tilde[2,1],xh,yh,zh)
    err_Dh22[i_ind] = L2_diff(D_tilde[2,2],xh,yh,zh)
...
file_err_Dh00 = '/mnt/home/jflores/Doi-OnsagerModel/sigma/k_is_0/err_Dh00.txt'
file_err_Dh01 = '/mnt/home/jflores/Doi-OnsagerModel/sigma/k_is_0/err_Dh01.txt'
file_err_Dh02 = '/mnt/home/jflores/Doi-OnsagerModel/sigma/k_is_0/err_Dh02.txt'
file_err_Dh10 = '/mnt/home/jflores/Doi-OnsagerModel/sigma/k_is_0/err_Dh10.txt'
file_err_Dh11 = '/mnt/home/jflores/Doi-OnsagerModel/sigma/k_is_0/err_Dh11.txt'
file_err_Dh12 = '/mnt/home/jflores/Doi-OnsagerModel/sigma/k_is_0/err_Dh12.txt'
file_err_Dh20 = '/mnt/home/jflores/Doi-OnsagerModel/sigma/k_is_0/err_Dh20.txt'
file_err_Dh21 = '/mnt/home/jflores/Doi-OnsagerModel/sigma/k_is_0/err_Dh21.txt'
file_err_Dh22 = '/mnt/home/jflores/Doi-OnsagerModel/sigma/k_is_0/err_Dh22.txt'

np.savetxt(file_err_Dh00,err_Dh00)
np.savetxt(file_err_Dh01,err_Dh01)
np.savetxt(file_err_Dh02,err_Dh02)
np.savetxt(file_err_Dh10,err_Dh10)
np.savetxt(file_err_Dh11,err_Dh11)
np.savetxt(file_err_Dh12,err_Dh12)
np.savetxt(file_err_Dh20,err_Dh20)
np.savetxt(file_err_Dh21,err_Dh21)
np.savetxt(file_err_Dh22,err_Dh22)
