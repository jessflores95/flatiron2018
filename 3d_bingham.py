...
## add plane wave perturbation to D                                                    
D_pert = np.zeros(D.shape,dtype=float)
D_pert[0,0,:,:,:] = (np.cos(kz*z))*initial_perturbation_size*nz/(2*np.pi) #only z affected                          
D_pert[0,1,:,:,:] = (np.cos(kz*z))*initial_perturbation_size*nz/(2*np.pi)
D_pert[0,2,:,:,:] = (np.cos(kz*z))*initial_perturbation_size*nz/(2*np.pi)
D_pert[1,0,:,:,:] = (np.cos(kz*z))*initial_perturbation_size*nz/(2*np.pi)
D_pert[1,1,:,:,:] = (np.cos(kz*z))*initial_perturbation_size*nz/(2*np.pi)
D_pert[1,2,:,:,:] = (np.cos(kz*z))*initial_perturbation_size*nz/(2*np.pi)
D_pert[2,0,:,:,:] = (np.cos(kz*z))*initial_perturbation_size*nz/(2*np.pi)
D_pert[2,1,:,:,:] = (np.cos(kz*z))*initial_perturbation_size*nz/(2*np.pi)
D_pert[2,2,:,:,:] = (np.cos(kz*z))*initial_perturbation_size*nz/(2*np.pi)
D += D_pert
